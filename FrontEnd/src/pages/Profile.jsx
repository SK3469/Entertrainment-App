                    ...
                    <div className='p-4 mt-2'>
                        <div className='flex flex-col gap-2 mb-4'>
                            <div className="flex items-center gap-3 text-lg">
                                <BiSolidUserCircle />
                                <span className=''>  Username: <span className='font-bold text-red-600 text-xl'>{myState.user.name}</span></span>
                            </div>
                            <div className="flex items-center gap-3 text-lg">
                                <MdEmail />
                                <span className=''>  Username: <span className='font-bold text-red-600 text-xl'>{myState.user.email}</span></span>
                            </div>
                        </div>
                        <Logout />
                    </div>
